export const topicSuggestions: Record<string, string[]> = {
    'gaertnern': [
...
export function generateMissingTopics(categoryId: string, currentCount: number): string[] {
  const suggestions = topicSuggestions[categoryId] || [];
